 ...
 * otherwise NULL.
 */
const void * stun_message_find (const StunMessage * msg, int /*StunAttribute*/ type,
    uint16_t *palen);
...
StunMessageReturn stun_message_find32 (const StunMessage *msg,
    int /*StunAttribute*/ type, uint32_t *pval);
...
StunMessageReturn stun_message_find64 (const StunMessage *msg,
    int /*StunAttribute*/ type, uint64_t *pval);
...
StunMessageReturn stun_message_find_string (const StunMessage *msg,
    int /*StunAttribute*/ type, char *buf, size_t buflen);
...
StunMessageReturn stun_message_find_addr (const StunMessage *msg,
    int /*StunAttribute*/ type, struct sockaddr_storage *addr, socklen_t *addrlen);
...
StunMessageReturn stun_message_find_xor_addr_full (const StunMessage *msg,
    int /*StunAttribute*/ type, struct sockaddr_storage *addr,
