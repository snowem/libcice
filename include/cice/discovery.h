...
typedef TAILQ_HEAD(_candidate_discovery_head, _candidate_discovery) candidate_discovery_head_t;
...
typedef TAILQ_HEAD(_candidate_refresh_head, _candidate_refresh) candidate_refresh_head_t;
